		...
		<table width="100%" cellpadding="0" cellspacing="0" border="0"
			...
			<tr>
				<td bgcolor="#FFFFFF" height="50">
					<br>
   <form action="drugclass!add" method="post">
      <table border="0" align="center" width="450">
        <tr>
          <td align="right">药品类型名称：</td>
          <td align="left">
        	<input type="text" name="drugclass.cname"/>
          </td>
        </tr>
        <tr>
          <td align="right">功能描述：</td>
          <td align="left"><textarea name="drugclass.description"></textarea></td>
        </tr>
        <tr>
