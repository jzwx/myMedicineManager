		...
		<tr bgcolor="#E0FBC4">
			<td id="sub_4" style="display: none">
				<table width="80%" align="center">
					<tr>
						<td height="22" onmouseover="this.style.backgroundColor='#ffffff'" onmouseout="this.style.backgroundColor=''">
							<a href="user!findinformcation?username=<%=session.getAttribute("username") %>" target="main" class="sub1">个人信息查看</a>
						</td>
					</tr>
					<tr>
						<td height="22" onmouseover="this.style.backgroundColor='#ffffff'" onmouseout="this.style.backgroundColor=''">
							<a href="user!prepassword?username=<%=session.getAttribute("username") %>" target="main" class="sub1">个人信息修改</a>
						</td>
					</tr>
					<tr>
						<td height="22" onmouseover="this.style.backgroundColor='#ffffff'" onmouseout="this.style.backgroundColor=''">
